    ...
    <div className="w-full bg-white">
      ...
      <section className="pt-12 pb-16 px-6">
        <div className="container mx-auto max-w-4xl">
          <Link href="/work" className="inline-flex items-center text-sm font-mono text-muted-foreground hover:text-primary transition-colors mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-8 border-y border-border">
            <div>
              <div className="text-xs font-mono text-muted-foreground mb-1 uppercase tracking-widest">Role</div>
              <div className="font-medium text-sm">{project.role}</div>
            </div>
            <div>
              <div className="text-xs font-mono text-muted-foreground mb-1 uppercase tracking-widest">Duration</div>
              <div className="font-medium text-sm">{project.duration}</div>
            </div>
            <div className="col-span-2">
              <div className="text-xs font-mono text-muted-foreground mb-1 uppercase tracking-widest">Services</div>
              <div className="font-medium text-sm text-primary">{project.services.join(", ")}</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-20">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6 flex items-center gap-4">
                <span className="text-primary font-mono text-sm block -mt-1 font-normal tracking-widest">01</span> 
                The Challenge
              </h2>
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6 flex items-center gap-4">
                <span className="text-primary font-mono text-sm block -mt-1 font-normal tracking-widest">02</span> 
                Discovery & Strategy
              </h2>
              <div className="space-y-6 text-lg text-foreground/80 leading-relaxed">
                <p><strong>Research:</strong> {project.discovery}</p>
                <p><strong>Approach:</strong> {project.strategy}</p>
              </div>
            </div>

            {/* Execution Placeholder Image 1 */}
            <div className="aspect-[16/9] bg-muted border border-border flex items-center justify-center">
               <span className="font-mono text-sm text-muted-foreground/50">Process Visual Placeholder</span>
            </div>

            {/* Execution */}
            <div>
              <h2 className="text-3xl font-bold mb-6 flex items-center gap-4">
                <span className="text-primary font-mono text-sm block -mt-1 font-normal tracking-widest">03</span> 
                Execution
              </h2>
              <div className="space-y-6 text-lg text-foreground/80 leading-relaxed">
                <p><strong>Design:</strong> {project.designDecisions}</p>
                <p><strong>Development:</strong> {project.developmentApproach}</p>
              </div>
              
              <div className="mt-8">
                <div className="text-xs font-mono text-muted-foreground mb-3 uppercase tracking-widest">Technologies Used</div>
             ...
             <div className="aspect-[16/9] bg-muted border border-border flex items-center justify-center">
               <span className="font-mono text-sm text-muted-foreground/50">Final Solution Visual Placeholder</span>
            </div>

            {/* Results */}
            <div>
              <h2 className="text-3xl font-bold mb-6 flex items-center gap-4">
                <span className="text-primary font-mono text-sm block -mt-1 font-normal tracking-widest">04</span> 
                The Results
              </h2>
      ...
      <section className="border-t border-border bg-muted/20 hover:bg-muted/40 transition-colors">
        <Link href={`/work/${nextProject.slug}`} className="block py-20 px-6 container mx-auto text-center group">
          <div className="text-sm font-mono text-muted-foreground mb-4 tracking-widest uppercase">Next Project</div>
